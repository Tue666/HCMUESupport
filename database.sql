...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 15, 2021 at 02:20 PM
...
INSERT INTO `orders` (`ID`, `CustomerID`, `CustomerName`, `CustomerEmail`, `CustomerAddress`, `CustomerPhone`, `MSSV`, `Object`, `Khoa`, `Place`, `Address`, `Note`, `CreatedDay`, `ReceivedDay`, `Status`) VALUES
...
(1, 'Trứng', 1, 'egg.jpg', 'Combo 1 slot 2 vỉ', 10, 20, '2021-07-25', 1),
(2, 'Rau muống', 1, 'image_not_found.png', NULL, 14, 20, '2021-07-25', 1),
(3, 'Nước lọc', 2, 'image_not_found.png', NULL, 17, 30, '2021-07-25', 1),
